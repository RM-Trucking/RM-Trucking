export const handleDelCarrierEditNext = async (dispatch, setValue, getValues, trigger, errors,
    ...
    if (isValid && validAccessorials && validReferenceTable && (validationResult.isValid)) {
