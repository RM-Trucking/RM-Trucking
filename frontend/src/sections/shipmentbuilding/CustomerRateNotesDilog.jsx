...
export default function CustomerRateNotesDilog({ open, handleClose, existingNotes = [], setValue, getValues, control, customerRateNotesArr,
appendCustomerRateNotesArr, currentCustomerNoteText }) {

  const handleAddNotes = () => {
    const currentText = getValues('customerRate.rateNotes');
    ...
    setValue('customerRate.rateNotes', '');
  };
            ...
            render={({ field: { onChange, value }, fieldState: { error } }) => (
              <Box>
                ...
                <Typography variant="caption" sx={{ fontWeight: 600, color: '#333', display: 'flex', gap: 0.5 }}>
                  Rate Notes <Box component="span" sx={{ color: 'red' }}>*</Box>
                </Typography>
