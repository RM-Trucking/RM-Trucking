...
export default function CarrierApprovalHistoryDilog({ sectionName, open, handleClose, approvalRateHistory }) {
            ...
            <DialogTitle sx={{ p: 1, pb: 1.5 }}>
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Box component="span" sx={{ fontWeight: 'bold' }}>
                        {(sectionName.toLowerCase().includes('pickup')) ? 'Pickup' : (sectionName.toLowerCase().includes('line haul')) ? 'Line Haul' : 'Delivery'} Carrier Approval History
                    </Box>
                    <Box>
